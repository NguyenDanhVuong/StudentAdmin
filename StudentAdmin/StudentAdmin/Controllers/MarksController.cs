...
namespace ProjectSem3withTeam.Controllers
{
    public class MarksController : Controller
    {
        ...
        {
            var studentAdmin = _context.Mark.Include(m => m.Student).Include(m => m.Subject);
            return View(await studentAdmin.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SubjectId,StudentRollNumber,SubjectMark,CreatedAt,UpdatedAt")] Mark mark)
        {
